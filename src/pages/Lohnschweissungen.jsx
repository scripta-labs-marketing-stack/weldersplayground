...
export default function LohnschweissungenPage() {
  ...
  const advantages = [
    ...
    "Einsatz modernster WIG-Schweißanlagen für höchste Präzision",
    "Langjährige Erfahrung mit komplexen Geometrien und Materialien",
    "Qualitätssicherung nach höchsten Industriestandards",
    "Termintreue und zuverlässige Projektabwicklung"
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <StyledHeading as="h2" text="Projektanfrage" className="text-xl md:text-3xl font-bold font-['Montserrat'] mb-6 md:mb-8" />
            ...
            {isSubmitted ? (
              <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 md:p-6 rounded-r-lg">
                ...
                <button 
                  onClick={() => {setIsSubmitted(false); setFormData({name: '', contact: '', project: ''})}}
